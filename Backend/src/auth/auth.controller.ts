...
// import { verifyTokenDto } from './dto/verifyToken.dto';
// import { JoiValidationPipe } from 'src/shared/utils/joiValidations';
// // import { SendOtpDto } from './dto/sendOtp.dto'; // Optional DTO
...
//   @ApiOperation({ summary: 'Send Otp by Email or Phone' })
//   @Throttle({ default: { limit: 2, ttl: 30 } })
//   @Post('sendotp')
//   @ApiBody({
//     schema: {
...
//   })
//   async sendOtp(
//     @Body() sendOtpDto: Record<string, any>, // You can replace with SendOtpDto
//     @Headers('userType') userType: string,
//   ) {
//     if (!sendOtpDto.input || !userType) {
//       throw new BadRequestException('Input and userType are required');
//     }
