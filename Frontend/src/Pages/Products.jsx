...
//   // Decide what categories to show
//   const categoriesToShow =
//     selectedCategory === null
//       ? rootCategories
//       : getChildCategories(selectedCategory.id);

//   // If there are no children, show products
...
//           <button
//             onClick={() => {
//               // Go back to parent category, or null if root
...
//         </div>
//       ) : (
//         <div className="text-center text-gray-500">{t("selectCategory") || "Please select a category."}</div>
//       )}
//     </div>
//   );
// }
