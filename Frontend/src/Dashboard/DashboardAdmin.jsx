          ...
          <table className="w-full table-auto text-sm lg:text-base">
            ...
            <tbody>
              <tr>
                ...
                <td className="text-start p-2">Admin 1</td>
                <td className="text-start p-2">admin1@example.com</td>
                <td className="text-start p-2">Super Admin</td>
              ...
              <tr>
                ...
                <td className="text-start p-2">Admin 2</td>
                <td className="text-start p-2">admin2@example.com</td>
                <td className="text-start p-2">Admin</td>
                <td className="text-start flex gap-2 p-2">
